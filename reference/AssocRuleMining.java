...
public class AssocRuleMining extends JFrame {
	 ...
	 * data array structure commencing at the given row index, continues until
	...
	/* ---------------------- */
	/**
	 * Outputs size (number of records and number of elements) of stored input
	 * data set read from input data file.
	 */
	...
	/* ------------------------ */
	/**
	 * Outputs conversion array (used to renumber columns for input data in
	 * terms of frequency of single attributes --- reordering will enhance
